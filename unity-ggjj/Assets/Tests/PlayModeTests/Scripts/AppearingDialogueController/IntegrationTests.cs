...
namespace Tests.PlayModeTests.Scripts.AppearingDialogueController
{
    ...
    public class IntegrationTests
    {
        ...
        {
            const string textToPrint = "Lorem ipsum dolor sit amet consectetur adipiscing elit Integer luctus leo nec mi pulvinar eget molestie purus gravida Aliquam imperdiet pharetra massa vel aliquam Pellentesq";
            ...
            _appearingDialogueController.CharacterDelay = 0.02f;
