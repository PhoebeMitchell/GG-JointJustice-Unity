...
namespace Tests.PlayModeTests.Scripts.AppearingDialogueController
{
    ...
    public class GetDelay
    {
        ...
        {
            Assert.AreEqual(REGULAR_CHARACTER_SPEED / SPEED_MULTIPLIER, _appearingDialogueController.GetDelay(character));
            _appearingDialogueController.SpeedMultiplier = SPEED_MULTIPLIER * 2;
            Assert.AreEqual(REGULAR_CHARACTER_SPEED / (SPEED_MULTIPLIER * 2), _appearingDialogueController.GetDelay(character));
        }
        ...
        {
            Assert.AreEqual(PUNCTUATION_CHARACTER_SPEED / SPEED_MULTIPLIER, _appearingDialogueController.GetDelay(character));
            _appearingDialogueController.SpeedMultiplier = SPEED_MULTIPLIER * 2;
            Assert.AreEqual(PUNCTUATION_CHARACTER_SPEED / (SPEED_MULTIPLIER * 2), _appearingDialogueController.GetDelay(character));
        }
        ...
        {
            Assert.AreEqual(expectedDelay / SPEED_MULTIPLIER, _appearingDialogueController.GetDelay(character));
            _appearingDialogueController.SpeedMultiplier = SPEED_MULTIPLIER * 2;
            Assert.AreEqual(expectedDelay / (SPEED_MULTIPLIER * 2), _appearingDialogueController.GetDelay(character));
        }
        ...
        public void VerifyRegularCharacterSpeedWithDisabledSkipping(char character)
        {
            ...
            Assert.AreEqual(REGULAR_CHARACTER_SPEED, _appearingDialogueController.GetDelay(character));
            _appearingDialogueController.SpeedMultiplier = SPEED_MULTIPLIER * 2;
            Assert.AreEqual(REGULAR_CHARACTER_SPEED, _appearingDialogueController.GetDelay(character));
        }
        ...
        {
            _appearingDialogueController.SkippingDisabled = true;
            Assert.AreEqual(PUNCTUATION_CHARACTER_SPEED, _appearingDialogueController.GetDelay(character));
            _appearingDialogueController.SpeedMultiplier = SPEED_MULTIPLIER * 2;
            Assert.AreEqual(PUNCTUATION_CHARACTER_SPEED, _appearingDialogueController.GetDelay(character));
        }
        ...
        {
            _appearingDialogueController.SkippingDisabled = true;
            Assert.AreEqual(expectedDelay, _appearingDialogueController.GetDelay(character));
            _appearingDialogueController.SpeedMultiplier = SPEED_MULTIPLIER * 2;
            Assert.AreEqual(expectedDelay, _appearingDialogueController.GetDelay(character));
        }
    }
